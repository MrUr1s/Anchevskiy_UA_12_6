...
public class PlayerControler : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        switch (_player)
        {
            case Players.Player1:
                ...
                _playerInput.Player1.PauseGame.performed += PauseGame_performed;
                break;
    ...
    {
        Time.timeScale = 0f;
        GameInterface.instance.GameMenuControl.transform.localScale = Vector3.one;
        GameInterface.instance.GameMenuControl.Interactable.Invoke(true);
    }
